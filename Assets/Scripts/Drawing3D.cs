...
public class Drawing3D : MonoBehaviour
{
    ...
    List<PCLDrawing> m_PointClouds = new List<PCLDrawing>();
    Queue<PCLDrawing> m_DormantPointClouds = new Queue<PCLDrawing>();
    ...
    public void Init(Material material, float duration = -1)
    {
        m_Mesh = new Mesh();
    ...
    public PCLDrawing AddPointCloud(int numPoints = 0, Material material = null)
    {
        PCLDrawing result;
        ...
        {
            result = PCLDrawing.Create(gameObject, numPoints, material);
        }
    ...
    public void Clear()
    {
        ...
        foreach (PCLDrawing pointCloud in m_PointClouds)
        {
            pointCloud.Clear();
