...
public class PCLDrawing : MonoBehaviour
{
    ...
    public static PCLDrawing Create(GameObject parent = null, int numPoints = 0, Material material = null)
    {
        ...
        PCLDrawing newDrawing = newDrawingObj.AddComponent<PCLDrawing>();
